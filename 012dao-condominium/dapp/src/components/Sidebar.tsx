...
import { doLogout, Profile } from "../services/Web3Services";
...
function Sidebar(){
    ...
    useEffect(()=>{
        const profile = parseInt(localStorage.getItem("profile") || "0" );
        setProfile(profile);
    }, [])

    function getAciveClass(item: string) : string {
    ...
    return(
        <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
            ...
            <ul className="navbar-nav">
                ...
                <a className= {getAciveClass("topics")} href="/topics">
...

                {
                    ...
                    ?
                        <li className="nav-item">
                        <a className={getAciveClass("residents")} href="/residents">
                            <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                }
                {
                    ...
                    ?
                        <li className="nav-item">
                        <a className={getAciveClass("quota")} href="/quota">
                            <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                }
                {
                    ...
                    <>
                        <li className="nav-item">
                        <a className={getAciveClass("transfer")} href="/transfer">
                            <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i className="material-icons opacity-10">payments</i>
                            </div>
                        ...
                        <li className="nav-item">
                        <a className={getAciveClass("settings")} href="/settings">
                            <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
