  ...
  return (
    <>
      <main className="main-content  mt-0">
        <div className="page-header align-items-start min-vh-100" style={{backgroundImage: "url('https://images.unsplash.com/photo-1574362848149-11496d93a7c7?q=80&w=1684&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')"}}>
                  ...
                  <div className="card-body">
                    <form role="form" className="text-start">
                      ...
                      <p className="mt-4 text-sm text-center">
                        ...
                        <a href="mailto:carlosamcruz@ufam.edu.br" className="text-primary text-gradient font-weight-bold ms-2">manager</a>
                      </p>
                    </form>
                  </div>
                </div>
